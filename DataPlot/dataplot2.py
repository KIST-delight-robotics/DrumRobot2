...
if __name__ == "__main__":
    # Path to txt files
    file1_path = '../DrumRobot_data/solveIK_q7_before.txt'  # Replace with your file path
    file2_path = '../DrumRobot_data/solveIK_q7.txt'  # Replace with your file path (or None for single plot)
