...
private:
    ...
    const float initial_joint_angles[12] = {10.0,   90.0,   90.0,   0.0,    135.0,  0.0,    135.0,   90.0,   90.0,    0.0,           0.0,    0.0};

    // 로봇의 관절각 범위
    //                                 Waist   Rarm1   Larm1   Rarm2   Rarm3   Larm2   Larm3   Rwrist   Lwrist   maxonForTest   Rfoot   Lfoot    [deg]
    const float joint_range_max[12] = {90.0,  150.0,  180.0,  90.0,   140.0,  90.0,   140.0,  135.0,  135.0,     135.0,         135.0,  135.0};
