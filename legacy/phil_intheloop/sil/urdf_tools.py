...
# ================================================================
# 실기와 비교했을 때 상완/하완 연결부가 바깥을 보이는 문제를 확인하기 위해,
# 체크인된 URDF/STL은 건드리지 않고 runtime URDF에서만 링크 visual/collision
# origin의 xyz/rpy를 보정합니다.
#
# 현재 2차 가설:
...
RUNTIME_LINK_FRAME_PATCH_POSE = {
    # ==========
    # left arm visual frame
    # ==========
    "left_shoulder_1": {
        "xyz_m": (0.0, 0.009238, -0.1795),
    ...
    # ==========
    # right arm visual frame
    # ==========
    "right_shoulder_1": {
        "xyz_m": (0.0, -0.011834, -0.1795),
        "rpy_deg": (180.0, 0.0, 0.0),
    },
    "right_shoulder_2": {
...
def _set_link_origin_pose(
    ...
    # visual/collision origin이 없으면 기본값으로 새로 만들고,
    # runtime 비교용 xyz/rpy 보정값으로 origin pose를 통째로 덮어씁니다.
